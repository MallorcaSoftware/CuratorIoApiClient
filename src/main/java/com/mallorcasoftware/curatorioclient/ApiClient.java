...
import com.mallorcasoftware.curatorioclient.auth.Authentication;
import com.mallorcasoftware.curatorioclient.auth.HttpBasicAuth;
import com.mallorcasoftware.curatorioclient.auth.ApiKeyAuth;
import com.mallorcasoftware.curatorioclient.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.curator.io/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("APIKeyQueryParam", new ApiKeyAuth("query", "api_key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.curator.io/v1
